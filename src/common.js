...
yy: {},
symbols_: {"error":2,"expression":3,"e":4,"EOF":5,"plus":6,"number":7,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"plus",7:"number"},
...
case 2:
        ...
        operator = node.createPlusNode($$[$0-1]);
        this.$ = operate($$[$0-2], operator, $$[$0]);
